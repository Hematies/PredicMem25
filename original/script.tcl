...
set_top prefetchWithSGASPWithNopWithDataflow
add_files PredicMem25/src/include/confidence_buffer.hpp
...
config_export -format sysgen -output /home/pablo/Escritorio/PredicMem25/SGASP_IP -rtl verilog
source "./PredicMem25/original/directives.tcl"
csim_design -argv {-vS}
csynth_design
cosim_design -argv {-vS}
export_design -rtl verilog -format ip_catalog -output /home/pablo/Escritorio/PredicMem25/SGASP_IP
