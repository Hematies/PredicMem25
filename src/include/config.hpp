...
#define AXI_BURST_LENGTH_LOG2 8
#define AXI_BURST_SIZE_LOG2 8
#define AXI_BURST_SIZE_BITFIELD_LOG2 3
// #define AXI_BURST_BLOCK_LOG2 (AXI_BURST_LENGTH_LOG2 + AXI_BURST_SIZE_LOG2 - BLOCK_SIZE_LOG2)

#define AXI_WRAP_BURST_LENGTH_LOG2 2 // Number of transfers in WRAP burst type: 2, 4, 8, 16
#define	AXI_BURST_BLOCK_LOG2 (bitsNeeded((1 << (AXI_BURST_SIZE_LOG2-1))) * 16 / (1 << BLOCK_SIZE_LOG2))
